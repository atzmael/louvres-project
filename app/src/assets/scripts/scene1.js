...
/* VARIABLES - Sprite */
const SPRITE_TAB = [
	[new THREE.TextureLoader().load("/assets/images/scenes/algue.png"), 29, 7],
	[new THREE.TextureLoader().load("/assets/images/scenes/buisson.png"), 17, 12],
	...
	[new THREE.TextureLoader().load("/assets/images/scenes/dune2.png"), 1, 1],
]
...
MESH_object = new Sprite(0, 70, -CAMERA_POSITION_Z + 1, 50, 150, new THREE.TextureLoader().load("/assets/images/scene-pyramide/pyramides_grand.png"), 1, 1, false)
