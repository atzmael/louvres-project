...
const SPRITE_TAB = [
	...
	[new THREE.TextureLoader().load("/assets/images/scenes/fleur-soleil.png"), 34, 6],
...
let MESH_wave0 = new Sprite(0, 3.2 - 2.5, CAMERA_POSITION_Z - 6, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_2_grand.png"), 1, 1, false)
...
MESH_wave0 = new Sprite(0, 3.3 - 2.5, CAMERA_POSITION_Z - 8, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_1_grand.png"), 1, 1, false)
...
MESH_wave0 = new Sprite(0, 3.4 - 2.5, CAMERA_POSITION_Z - 10, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_3_grand.png"), 1, 1, false)
MESH_wave0_positionX = MESH_wave0.SPRITE_OBJECT.position.x
MESH_wave0_positionY = MESH_wave0.SPRITE_OBJECT.position.y
...
MESH_wave0 = new Sprite(0, 3.5 - 2.5, CAMERA_POSITION_Z - 12, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_2_grand.png"), 1, 1, false)

MESH_TAB.push(MESH_wave0)
MESH_GROUP.add(MESH_wave0.SPRITE_OBJECT)

MESH_wave0 = new Sprite(0, 3.6 - 2.5, CAMERA_POSITION_Z - 14, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_1_grand.png"), 1, 1, false)
MESH_wave0_positionX = MESH_wave0.SPRITE_OBJECT.position.x
MESH_wave0_positionY = MESH_wave0.SPRITE_OBJECT.position.y
...
MESH_wave0 = new Sprite(0, 3.7 - 2.5, CAMERA_POSITION_Z - 16, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_3_grand.png"), 1, 1, false)
MESH_wave0_positionX = MESH_wave0.SPRITE_OBJECT.position.x
MESH_wave0_positionY = MESH_wave0.SPRITE_OBJECT.position.y
...
let MESH_wave01 = new Sprite(0, 3.8 - 2.5, CAMERA_POSITION_Z - 18, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_2_grand.png"), 1, 1, false)
...
let MESH_wave02 = new Sprite(0, 3.9 - 2.5, CAMERA_POSITION_Z - 20, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_1_grand.png"), 1, 1, false)
...
let MESH_wave03 = new Sprite(0, 4 -2.5, CAMERA_POSITION_Z - 22, 35, 8, new THREE.TextureLoader().load("/assets/images/scene-chat/vague_3_grand.png"), 1, 1, false)
...
MESH_object = new Plane(0, 50 / 2 - 5.5, -CAMERA_POSITION_Z - 10, new THREE.TextureLoader().load("/assets/images/ciel-1.jpg"), 200, 100)
...
MESH_object = new Sprite(-10, 2 - 2.5, -CAMERA_POSITION_Z + 10, 15, 5, new THREE.TextureLoader().load("/assets/images/scene-momie/sphynx.png"), 1, 1, false)

MESH_TAB.push(MESH_object)
MESH_GROUP.add(MESH_object.SPRITE_OBJECT)

MESH_object = new Sprite(10, 2 - 2.5, -CAMERA_POSITION_Z + 10, 15, 5, new THREE.TextureLoader().load("/assets/images/scene-momie/sphynx-2.png"), 1, 1, false)

MESH_TAB.push(MESH_object)
MESH_GROUP.add(MESH_object.SPRITE_OBJECT)

MESH_object = new Sprite(0, 45 - 2.5, -CAMERA_POSITION_Z + 1, 8, 70, new THREE.TextureLoader().load("/assets/images/scene-momie/sarcophage_grand.png"), 1, 1, false)
...
function update() {
	...
	if (MESH_GROUP.position.z < 45) {
		...
		document.querySelector('.scene3 .js-click').style.display = "block";
		TweenLite.to(document.querySelector('.scene3 .js-click'), 0.4, {opacity: 1})
	}
